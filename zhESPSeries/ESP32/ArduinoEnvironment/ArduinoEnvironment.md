...
### 1． 安装Arduino IDE ，可以从[arduino.cc](https://www.arduino.cc/en/Main/Software) 下载Arduino IDE客户端。

### 2． 安装Git GUI，可以从[git-scm.com](https://git-scm.com/download/win) 下载Git GUI客户端。
